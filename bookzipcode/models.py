...
class BookOrder(models.Model):
    ...
    book_after_builders_cleaning_also_include = models.TextField(max_length=200, blank=True)
    builders_cleaning_also_include2 = models.CharField(max_length=100, blank=True)
